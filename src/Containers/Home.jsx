      ...
      <div className={classes.root}>
        ...
        <div className={classes.leftFeature}>
          ...
          <div className={classes.leftFeatureText}>
            ...
            <MainButton variant="outlined" component={Link} to="/signup">sign up, it's free.</MainButton>
          </div>
        </div>
        {/* One bigger card and description of one feature */}
        ...
        <div className={classes.leftFeature}>
          ...
          <div className={classes.leftFeatureText}>
            ...
            <Typography variant="h5">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam dolor
              doloribus vel. Suscipit saepe numquam culpa impedit maiores
              mollitia pariatur obcaecati maxime, ea excepturi, nam esse porro
              optio.
            </Typography>
            <Typography variant="h6">
              > Lorem ipsum dolor sit amet consectetur adipisicing elit.
        ...
        <div className={classes.generalDescription}>
          ...
          <div>
            <Typography variant="body1" align="center">
              ...
              Ex dolor earum, laborum incidunt expedita sed quis facilis, qui
              libero dicta id? Tempore neque modi laborum eveniet ratione,
        ...
        <div className={classes.topCards}>
          <PresentationCard
            ...
            image="https://images.unsplash.com/photo-1518183214770-9cffbec72538?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80"
          />
          <PresentationCard
            title="Money on the go"
            image="https://images.unsplash.com/photo-1497161884053-1d0d43fe3c61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1189&q=80"
          />
          <PresentationCard
            title="One step at a time"
            image="https://images.unsplash.com/photo-1516321497487-e288fb19713f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80"
          />
        </div>
        ...
        <div className={classes.finalInvitation}>
          ...
          <div>
            <Typography variant="body1" align="center">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. commodi.
              Ex dolor earum, laborum incidunt expedita sed quis facilis,
              commodi. Ex dolor earum, laborum incidunt expedita sed quis
              facilis, commodi. Ex dolor earum, laborum incidunt expedita sed
              quis facilis, commodi. Ex dolor earum, laborum incidunt expedita
              sed quis facilis, saepe maiores, expedita deleniti!
            </Typography>
          </div>
